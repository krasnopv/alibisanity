      ...
      structure: (S) =>
        S.list()
          ...
          .items([
            ...
            .icon(FileText)
            .id('pages')
            .child(S.documentList().id('pages-list').filter('_type == "page"')),
            ...
            S.listItem()
              ...
              .icon(Tag)
              .id('tags')
              .child(S.documentList().id('tags-list').filter('_type == "serviceTag"')),
                ...
                S.list()
                  ...
                  .items([
                    S.listItem()
                      ...
                      .id('all-directors')
                      .icon(User)
                      .child(S.documentList().id('all-directors-list').filter('_type == "director"')),
                    S.listItem()
                      .title('Trophies/Awards')
                      .id('trophies')
                      .icon(Award)
                      .child(S.documentList().id('trophies-list').filter('_type == "trophy"')),
                    S.listItem()
                      .title('Director Works')
                      .id('director-works')
                      .icon(Video)
                      .child(S.documentList().id('director-works-list').filter('_type == "directorWork"')),
                  ])
              ),
            ...
            S.listItem()
              ...
              .icon(Users)
              .id('team-members')
              .child(S.documentList().id('team-members-list').filter('_type == "teamMember"')),
          ])
    }), 
    visionTool()
